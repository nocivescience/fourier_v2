...
class AbstractFourierOfTexSymbol(ZoomedScene):
    ...
    def construct(self):
        ...
        if self.CONFIG['scale_zoom_camera_to_full_screen']:
            self.CONFIG['run_time'] -= self.CONFIG['scale_zoom_camera_to_full_screen_at']
    ...
    def scale_zoom_camera_to_full_screen_config(self):
        ...
        def update_camera(mob, dt):
            ...
            if mob.start_time <= run_time:
                ...
                alpha_func = self.CONFIG['zoom_camera_to_full_screen_config']["func"](alpha)
